...
const translations = {
  ko: {
    ...
    "dashboard.quickMenu": "바로가기",
    "dashboard.quickTasks": "할 일",
    "dashboard.quickSchedule": "일정",
    "dashboard.quickDday": "디데이",
    "dashboard.quickUpload": "업로드",
    "dashboard.taskManagerTitle": "오늘의 할 일 관리",
    "dashboard.taskManagerDescription": "오늘 처리할 항목을 추가하고 완료 여부와 우선순위를 관리하세요.",
    "dashboard.scheduleManagerTitle": "오늘 일정 보기",
    "dashboard.scheduleManagerDescription": "고정 일정에서 등록한 오늘의 시간을 순서대로 확인하세요.",
    "dashboard.todayScheduleEmpty": "오늘 등록된 일정이 없습니다.",
    "dashboard.deadlineManagerTitle": "디데이 관리",
    "dashboard.deadlineManagerDescription": "기한이 있는 항목을 날짜순으로 확인하고 수정하세요.",
    "dashboard.loadError": "대시보드 데이터를 불러오지 못했습니다. 잠시 후 다시 시도해주세요.",
  ...
  en: {
    ...
    "dashboard.quickMenu": "Shortcuts",
    "dashboard.quickTasks": "Tasks",
    "dashboard.quickSchedule": "Schedule",
    "dashboard.quickDday": "D-Day",
    "dashboard.quickUpload": "Upload",
    "dashboard.taskManagerTitle": "Task Manager",
    "dashboard.taskManagerDescription": "Add today's items and manage completion and priority.",
    "dashboard.scheduleManagerTitle": "Daily Schedule",
    "dashboard.scheduleManagerDescription": "Review today's time blocks from your fixed schedule.",
    "dashboard.todayScheduleEmpty": "No schedules registered for today.",
    "dashboard.deadlineManagerTitle": "D-Day Manager",
    "dashboard.deadlineManagerDescription": "Review and edit time-sensitive items by date.",
    "dashboard.loadError": "Could not load dashboard data. Please try again later.",
